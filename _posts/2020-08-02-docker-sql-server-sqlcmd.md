# SQL SERVER on Docker (Round 2)

Let's revisit a previous [post](./2019-12-07-docker-sql-server.html) about using Docker to create a SQL SERVER image.  Previously, I connected to the DB with SQL SERVER Management Studio (SSMS), but now, I'd like to use `sqlcmd` to avoid running other tools.
